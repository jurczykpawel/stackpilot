...
# Apps with DB_BUNDLED=true have their own database in docker-compose (e.g. Postiz, AFFiNE)
...
[ -n "$CONTAINER_CONFIG" ] && EXTRA_ENV="$EXTRA_ENV CONTAINER_CONFIG='$CONTAINER_CONFIG'"
[ -n "$NOTIFICATION_URL" ] && EXTRA_ENV="$EXTRA_ENV NOTIFICATION_URL='$NOTIFICATION_URL'"
[ -n "$REPO_USER" ] && EXTRA_ENV="$EXTRA_ENV REPO_USER='$REPO_USER'"
[ -n "$REPO_PASS" ] && EXTRA_ENV="$EXTRA_ENV REPO_PASS='$REPO_PASS'"
[ -n "$WATCHTOWER_SCHEDULE" ] && EXTRA_ENV="$EXTRA_ENV WATCHTOWER_SCHEDULE='$WATCHTOWER_SCHEDULE'"
[ -n "$WATCHTOWER_MODE" ] && EXTRA_ENV="$EXTRA_ENV WATCHTOWER_MODE='$WATCHTOWER_MODE'"
