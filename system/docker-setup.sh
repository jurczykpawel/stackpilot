...
echo "--- 2. Applying VPS-specific optimizations (Log Rotation) ---"
...
echo "Docker configuration (/etc/docker/daemon.json):"
...
echo ""
echo "✅ Docker is installed (via NOOBS) and optimized for your VPS!"
